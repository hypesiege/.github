...
This GitHub account maintains software, infrastructure, research, and supporting documentation under the [`hypesiege`](https://github.com/hypesiege) GitHub owner.

Planning and delivery context is tracked in [github.com/hypesiege](https://linear.app/denman/project/githubcomhypesiege-12bdb95b4116). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/hypesiege/.github).
