...
# Repository relationships for `hypesiege`
...
- Inventory digest: `sha256:7ac32d981a45c3c440a913bee9df9a6691eda8275894a27845811f9803969a85`

## Immutable routing identity

| Field | Value |
|---|---|
| Mapping ID | `context:hypesiege` |
| GitHub owner ID | `311153811` |
| Linear project ID | `cd247cb1-870b-471e-89f6-9484df19e798` |
...
|---|---|---|---|
| `hypesiege/.github` | `public` | `community-health`, `governance`, `relationship-registry` | no |
