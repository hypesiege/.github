# hypesiege organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`hypesiege`](https://github.com/hypesiege).

## Canonical organization links

- GitHub organization: https://github.com/hypesiege
- Public organization defaults: https://github.com/hypesiege/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomhypesiege-12bdb95b4116
...
`hypesiege` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
